...
//public class DocumentListWidgetOld extends BaseProcessToolWidget implements ProcessToolDataWidget,
...
//
//        DocumentProviderRegistry providerRegistry = ProcessToolContext.Util.getProcessToolContextFromThread().getRegistry().lookupService(
//                DocumentProviderRegistry.class.getName());
//
//        providerRegistry.getProvider(documentProviderName, null //load properties from documentProviderConfig)
//        );
//
